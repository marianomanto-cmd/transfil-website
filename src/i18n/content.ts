    ...
    tech: [
      {
        ...
        bullets: [
          ...
          { name: 'Líneas centralizadas', img: '/img/t01-centralized-lines.jpg', desc: 'Sistemas multi-máquina que evacúan viruta de toda una nave hacia un punto único de descarga. Conectan decenas de máquinas-herramienta a un mismo circuito de transporte y eliminan la manipulación manual entre estaciones. Liberan personal y reducen el tiempo de paro por limpieza.', kind: 'photo' },
    ...
    tech: [
      {
        ...
        bullets: [
          ...
          { name: 'Centralized lines', img: '/img/t01-centralized-lines.jpg', desc: 'Multi-machine systems that evacuate chips from a whole shop floor to a single discharge point. Dozens of machine tools share a single transport circuit, eliminating manual handling between stations. Frees up staff and cuts cleanup downtime.', kind: 'photo' },
      ...
      },
      {
        ...
        bullets: [
          { name: 'Pass-through & rotary', img: '/img/t02-pass-through.webp', desc: 'Continuous pass-through cabins with belt or rotary table for serial production. Configurable cycle: wash, rinse, dry. They integrate into the existing line, synchronizing load, unload and bath temperature with the plant\'s rhythm.', kind: 'photo' },
