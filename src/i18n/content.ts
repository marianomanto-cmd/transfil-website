...
export const CONTENT: Record<Lang, Content> = {
  es: {
    ...
    hero: {
      ...
      sub: 'Diseñamos, fabricamos y mantenemos maquinaria especializada para la industria metalúrgica, automotriz y de máquinas-herramienta.',
    ...
    tech: [
      {
        id: 'conveyors', code: 'T01', title: 'Transportadores de viruta', sub: 'Conveyors',
        img: '/img/conveyor-blue.avif',
        ...
        bullets: [
          { name: 'Bisagra y raspador', img: '/img/conveyor-blue.avif', desc: 'Cadena articulada con paletas raspadoras. Ideal para virutas largas, mixtas y húmedas. Construcción robusta para operación continua 24/7.', kind: 'photo' },
          ...
          { name: 'Líneas centralizadas', img: '/img/welding-line.avif', desc: 'Sistemas multi-máquina que evacúan viruta de toda una nave hacia un punto único de descarga. Reduce manipulación manual.', kind: 'photo' },
  ...
  en: {
    ...
    hero: {
      ...
      sub: 'We design, build and maintain specialized machinery for the metallurgic, automotive and machine-tool industries.',
    ...
    tech: [
      {
        id: 'conveyors', code: 'T01', title: 'Chip conveyors', sub: 'Transportadores',
        img: '/img/conveyor-blue.avif',
        ...
        bullets: [
          { name: 'Hinge & scraper', img: '/img/conveyor-blue.avif', desc: 'Articulated chain with scraper paddles. Ideal for long, mixed and wet chips. Heavy-duty build for 24/7 operation.', kind: 'photo' },
          ...
          { name: 'Centralized lines', img: '/img/welding-line.avif', desc: 'Multi-machine systems that evacuate chips from a whole shop floor to a single discharge point. Reduces manual handling.', kind: 'photo' },
