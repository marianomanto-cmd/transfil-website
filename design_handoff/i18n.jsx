// i18n.jsx — bilingual content store for Trans-Fil site.
// All copy lives here so the React tree just reads from `t(lang).key`.
...
const TF_CONTENT = {
  es: {
    ...
    tech: [
      {
        id: "conveyors",
        code: "T01",
        title: "Transportadores de viruta",
        sub: "Conveyors",
        img: "img/conveyor-blue.avif",
        desc: "Sistemas de evacuación de viruta metálica para celdas de mecanizado, líneas transfer y centros CNC. Configurables en bisagra, raspador, magnéticos o combinados.",        bullets: [
    ...
    industries: {
      ...
      title: "Donde se trabaja el metal,",
      title2: "ahí estamos.",
    ...
    history: {
      ...
      milestones: [
        ...
        { y: "2024", t: "Nueva planta", d: "Ampliación de capacidad de fabricación en Av. Circunvalación." },
      ],
    },
    contact: {
      eyebrow: "[ 07 — Contacto ]",
      ...
      addr: "Av. Circunvalación 3043, Córdoba, Argentina",
    },
    footer: {
      tag: "Maquinaria industrial especializada",
      rights: "Todos los derechos reservados.",
      built: "Trans-Fil S.R.L.",
    },
    chips: {
  ...
  en: {
    ...
    hero: {
      ...
      ctaPrimary: "Explore technologies",
    ...
    industries: {
      ...
      title: "Wherever metal is worked,",
      title2: "we're there.",
    ...
    history: {
      ...
      milestones: [
        ...
        { y: "2024", t: "New facility", d: "Manufacturing capacity expansion at Av. Circunvalación." },
      ],
    },
    contact: {
      eyebrow: "[ 07 — Contact ]",
    ...
    footer: {
      tag: "Specialized industrial machinery",
...
window.TF_CONTENT = TF_CONTENT;
window.TF_CLIENTS = TF_CLIENTS;
