    ...
    tech: [
      ...
      },
      {
        ...
        bullets: [
          ...
          { name: 'Centrales hidráulicas', img: '/img/hydraulic-station-2.avif', desc: 'Estaciones de bombeo, presurización y temperado del refrigerante para múltiples máquinas en paralelo.', kind: 'photo' },
    ...
    tech: [
      ...
      },
      {
        ...
        bullets: [
          ...
          { name: 'Hydraulic stations', img: '/img/hydraulic-station-2.avif', desc: 'Pumping, pressurization and tempering stations for coolant feeding multiple machines in parallel.', kind: 'photo' },
