    ...
    tech: [
      ...
      },
      {
        ...
        bullets: [
          ...
          { name: 'Recuperación de aceite', img: '/img/t02-oil-recovery.webp', desc: 'Skimmers de banda y separadores coalescentes que retiran el aceite tramposo del refrigerante para reusar el fluido.', kind: 'photo' },
        ],
      },
      {
        ...
        bullets: [
          ...
          { name: 'Corte plasma', img: '/video/t04-plasma-cutting.mp4', poster: '/img/t04-plasma-cutting-poster.webp', desc: 'Prestamos servicios de corte por plasma para la industria de hasta 25,4 mm (1 pulgada).', kind: 'video' },
          { name: 'Plegado industrial', img: '/video/t04-industrial-bending.mp4', poster: '/img/t04-industrial-bending-poster.webp', desc: 'Plegadora CNC para plegados de hasta 3 m.', kind: 'video' },
          { name: 'Producción en serie', img: '/img/t04-serial-production.webp', desc: 'Nuestra capacidad industrial, décadas de experiencia y extensa red de proveedores nos permiten producir piezas para la industria metalúrgica en lotes con alta capacidad de respuesta.', kind: 'photo' },
        ],
      },
    ],
    catalogs: {
    ...
    tech: [
      ...
      },
      {
        ...
        bullets: [
          ...
          { name: 'Oil recovery', img: '/img/t02-oil-recovery.webp', desc: 'Belt skimmers and coalescing separators that remove tramp oil from coolant to reuse the fluid.', kind: 'photo' },
        ],
      },
      {
        ...
        bullets: [
          ...
          { name: 'Plasma cutting', img: '/video/t04-plasma-cutting.mp4', poster: '/img/t04-plasma-cutting-poster.webp', desc: 'Plasma cutting services for industry, up to 25.4 mm (1 inch).', kind: 'video' },
          { name: 'Industrial bending', img: '/video/t04-industrial-bending.mp4', poster: '/img/t04-industrial-bending-poster.webp', desc: 'CNC press brake for bends up to 3 m.', kind: 'video' },
          { name: 'Serial production', img: '/img/t04-serial-production.webp', desc: 'Our industrial capacity, decades of experience and extensive supplier network let us produce metalworking parts in batches with fast turnaround.', kind: 'photo' },
        ],
      },
    ],
    catalogs: {
